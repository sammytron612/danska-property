@extends('layouts.app', ['title' => 'Hotels','noIndex' => true])
<div style="margin-top:150px" class="container">
    <div class="row row-cols-1 row-cols-lg-2 gy-5 gx-4">
        ...
        <div class="col">
            ...
            <h3 class="d-block d-md-none">5-star repairs and maintenance solution for hotels.</h3>
            <p>Maintain your facilities to the highest standards and keep operating at maximum capacity..</p>
        </div>
        <div>
            <img data-aos="fade-up" alt="Hotel" data-aos-delay="200" class="rounded img-fluid" src="/assets/img/hotel.jpg">
        </div>
        <div class="col">
        ...
        <div class="col">
            <div class="heading">
                <h3>
                    Agile supply chain<span class="primary-green">.</span>
                </h3>
            </div>
            ...
            <div class="mt-3 copy">
                ...
                <p><span>Improve your time to solve any maintenance issue, and keep your business up and running. </span></p>
            </div>
        </div>
