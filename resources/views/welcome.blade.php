    ...
    <div class="container">
      <div class="row justify-content-between gy-5">
        <div class="col-lg-5 order-2 order-lg-1 d-flex flex-column justify-content-center align-items-center align-items-lg-start text-center text-lg-start">
          <h2 data-aos="fade-up">Data driven property management for<br>clients</h2>
          <p data-aos="fade-up" data-aos-delay="100">Empowers landlords and property managers to deliver repairs, compliance, voids and resident services through a simple work order management platform and a network of trade professionals..</p>
  ...
  <main id="main">
    ...
    <section id="about" class="about">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row gy-4">
          <div class="col-lg-7 position-relative about-img" style="background-image: url(assets/img/workers2.jpeg) ;" data-aos="fade-up" data-aos-delay="150">
          ...
          <div class="col-lg-5 d-flex align-items-end" data-aos="fade-up" data-aos-delay="300">
            <div class="content ps-0 ps-lg-5">
              <p class="fst-italic">
                ...
                <p>Lastyear we expanded into property management offering clients a wide range of services</p>
...
We help communities flourish with better, safer homes and access to business opportunities.
            ...
            <div class="row gy-4">
              ...
              <div class="col-xl-4" data-aos="fade-up" data-aos-delay="400">
                <div class="icon-box d-flex flex-column justify-content-center align-items-center">
                  ...
                  <p>We are focussed on delivering the best outcome for our customers. We believe the impossible is possible, through dedication and focus.</p>
                </div>
              </div><!-- End Icon Box -->
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="100">
            <div class="chef-member">
              ...
              <div class="member-info">
                ...
                <p>Alex has been a business man for over 40 Years. He has been the face behind some big property developments her in the UK and Denmark. Today his time being soley put into Danska Propery services and building the brand.</p>
              </div>
            </div>
          </div>
          ...
          <div class="col-lg-4 col-md-6 d-flex align-items-stretch" data-aos="fade-up" data-aos-delay="300">
            <div class="chef-member">
              ...
              <div class="member-info">
                ...
                <span style="color:black;font-weight: 600;">Head of Sales</span>
                <p>Juliehas not been with us long but With over 20 Years experience in sales Julie is focusing on driving sales and building the Danska profile within the UK.</p>
              </div>
            </div>
          </div>
    ...
    <section id="contact" class="contact">
      <div class="container" data-aos="fade-up">
        ...
        <div class="mb-3">
          <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d4596.276986545969!2d-1.4871780223077447!3d54.830251901094925!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x487e633b55fd84d1%3A0x544a73a25fa84695!2sHoughton%20le%20Spring%20DH4%205QY!5e0!3m2!1sen!2suk!4v1663850722825!5m2!1sen!2suk" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
