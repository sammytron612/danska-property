...
<div style="margin-top:150px;" class="container">
    <div id="carbon" class="row row-cols-1 row-cols-lg-2">
        <div class="col order-2 order-lg-1">
            <h2 class="display-6 pb-2 mt-lg-0 mt-5">We go live</h2>
            <h6 class="mt-5" data-hs-cos-type="rich_text"><p>Danska Property Services is proud to anounce the Go-Live date of its brand new services on Monday 3rd October 2022.</h6>
            <p><!--more--></p>
