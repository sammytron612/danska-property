...
<div style="margin-top:150px;" class="container">
    <div id="carbon" class="row row-cols-1 row-cols-lg-2">
        <div class="col order-2 order-lg-1">
            <h2 class="display-6 pb-2 mt-lg-0 mt-5">What the weak pound means for the mortgage market</h2>
            <span id="hs_cos_wrapper_post_body" class="mt-5" data-hs-cos-type="rich_text"><p>The value of the pound has tumbled following Chancellor Kwasi Kwarteng’s mini-Budget. We take a look at what it’s likely to mean for mortgage rates.</p>
            <p><!--more--></p>
            <p>The value of the pound has fallen steeply since Chancellor Kwasi Kwarteng delivered his mini-Budget.
                ...
                We take a look at why the pound has dived and what this means for homeowners.</p>
            <p>The pound has been weakening for some time against the dollar in line with other global currencies as the US central bank, the Federal Reserve, increases interest rates in the USA, drawing in international investors.

                <h5>Why has the pound fallen so much?</h5>
                ...
                Unfortunately, the markets don’t agree.</p>

                <p>Investors are worried that the Chancellor’s giveaways will lead to higher inflation, which will mean higher interest rates that will reduce economic growth.
                ...
                This has made them lose confidence in the pound, leading to them selling the currency, causing its value to drop.</p>
